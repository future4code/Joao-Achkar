...
console.log(sum)*/
//O código acima está somando o valor de i à let sum cada vez que ele é rodado.
//Na primeira rodada, o valor de i recebe o acréscimo de +1, para então 
//ser somado ao valor inicial de sum, que é 0, + o valor de sum acrescido do valor de i.
//Daí em diante, o último valor de sum vai sendo retomado e acrescido do valor 
//de i+1, até que i chegue no valor limite = 15.
//O resultado impresso no console é 105, que é o valor final de sum
...
//a. O comando .push adiciona um elemento ao array novaLista
//b. [ 10, 15, 25, 30 ]
//c. se a variável número tivesse o valor de 3, seria impresso no console, os valores de lista
//múltiplos de 3: [ 12, 15, 18, 21, 27, 30 ]
//se a variável número tivesse o valor de 4, seria impresso no console, os valores de lista
//múltiplos de 4: [ 12 ]
...
//O resultado impresso no console se o usuário digitasse o número 4 seria:
...
//Porque a cada vez que o código é rodado, o valor de 'let quantidadeAtual' é
//acrescido de +1, ao passo que o valor de linha é acrescido do seu próprio 
//valor inicial, que é indefinido, mais o dígito "0", como uma concatenação de 
//strings com value = "0". E a cada rodada do código, esse valor de linha é impresso 
//no console, até que o valor de quantidadeAtual chegue a quatro, para fazer o
//código parar de rodar.
...
//Após o enunciado, há um exemplo de qual deve ser a resposta final de cada 
//programa individualmente.

//a. Escreva um programa que devolva o maior e o menor números contidos 
//no array original

/*const original = [23, 56, 41, 11, 25, 12, 34, 191, 57]
...
//b.Escreva um programa que devolva um novo array contendo todos os valores 
//do array original divididos por 10

/*let original = [23, 56, 41, 11, 25, 12, 34, 191, 57]
const novoArray = []
for(let i = 0; i < original.length; i++) {
...
//nossa, sério, foi uma emoção chegar nesse resultado! rsrs, tava muito difícil pensar

//c. Escreva um programa que devolva um novo array contendo, somente, os números pares do
//array original.
/*
const original = [23, 56, 41, 11, 25, 12, 34, 191, 57]
const novoArray = []
...
//d. Escreva um programa que gere um novo array contendo strings, da seguinte 
//forma: "O elemento do índex i é: numero"
/*
const original = [23, 56, 41, 11, 25, 12, 34, 191, 57]
const novoArray = []
const index = original.length
for(let i = 0; i < original.length; i++){
    novoArray.push("O elemento do índex " + (original.length - original.length + i) + " é " + original[i])
}
console.log(novoArray)
*/
//gente eu tô me sentindo nem sei o quê agora, eu consegui essas letras b c d agora tipo assim, numa sagacidade
//misturada com incerteza impressionante hahaha. Socoorr